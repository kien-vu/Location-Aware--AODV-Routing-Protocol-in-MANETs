...
#set val(sc)		"sc-x2000-y2000-n40-s25-t40ha"
set val(sc)		"sc-para"

set val(out)            "hls_gpsr.tr"
...
proc finish {} {
  ...
  # exec nam queue.nam &
	#exec awk -f Matgoi.awk hls_gpsr.tr > Lostgpsr.tr &
...
$sink2 set_filename gpsranh2.7MB.JPG
